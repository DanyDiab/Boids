public class ExperimentRecord {
    ...
    public int numBoids {get; set;}
    public int leafCapacityOrCellSize {get; set;}

    public SearchAlgos searchAlgo {get; set; }

    public ExperimentRecord(float averageDensity, float averageTotalMS, float averageChecks, float averageChecksPerBoid, SearchAlgos searchAlgo, int numBoids, int leafCapacityOrCellSize) {
